        ...
        <form action="calculate.php" method="post">
            ...
            <div class="date-time-group">
                <div>
                    ...
                    <input type="text" id="start_datetime" name="start_datetime" class="datetimepicker-input"
            ...
            <div class="date-time-group">
                <div>
                    ...
                    <input type="text" id="end_datetime" name="end_datetime" class="datetimepicker-input"
                        required readonly="readonly">
                </div>
            </div>
